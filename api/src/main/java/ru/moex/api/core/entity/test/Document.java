...
public class Document {
    ...
    @Basic
    @Column(name = "IS_ON_CURRENCY_MRKT", nullable = true, precision = 0)
    public Boolean getOnCurrencyMrkt() {
        return isOnCurrencyMrkt;
    }

    public void setOnCurrencyMrkt(Boolean onCurrencyMrkt) {
        isOnCurrencyMrkt = onCurrencyMrkt;
    }

    @Basic
    @Column(name = "IS_ON_STOCK_MRKT", nullable = true, precision = 0)
    public Boolean getOnStockMrkt() {
        return isOnStockMrkt;
    }

    public void setOnStockMrkt(Boolean onStockMrkt) {
        isOnStockMrkt = onStockMrkt;
    }

    @Basic
    @Column(name = "IS_ON_CURRENCY_DERIVATIVE_MRKT", nullable = true, precision = 0)
    public Boolean getOnCurrencyDerivativeMrkt() {
        return isOnCurrencyDerivativeMrkt;
    }

    public void setOnCurrencyDerivativeMrkt(Boolean onCurrencyDerivativeMrkt) {
        isOnCurrencyDerivativeMrkt = onCurrencyDerivativeMrkt;
    }

    @Basic
    @Column(name = "IS_ON_STOCK_DERIVATIVE_MRKT", nullable = true, precision = 0)
    public Boolean getOnStockDerivativeMrkt() {
        return isOnStockDerivativeMrkt;
    }

    public void setOnStockDerivativeMrkt(Boolean onStockDerivativeMrkt) {
        isOnStockDerivativeMrkt = onStockDerivativeMrkt;
    }

    @Basic
    @Column(name = "IS_ON_GOVERNMENT_MRKT", nullable = true, precision = 0)
    public Boolean getOnGovernmentMrkt() {
        return isOnGovernmentMrkt;
    }

    public void setOnGovernmentMrkt(Boolean onGovernmentMrkt) {
        isOnGovernmentMrkt = onGovernmentMrkt;
    }

    @Basic
    @Column(name = "IS_IN_CURRENCY_CLEARING", nullable = true, precision = 0)
    public Boolean getInCurrencyClearing() {
        return isInCurrencyClearing;
    }

    public void setInCurrencyClearing(Boolean inCurrencyClearing) {
        isInCurrencyClearing = inCurrencyClearing;
    }

    @Basic
    @Column(name = "IS_IN_STOCK_CLEARING", nullable = true, precision = 0)
    public Boolean getInStockClearing() {
        return isInStockClearing;
    }

    public void setInStockClearing(Boolean inStockClearing) {
        isInStockClearing = inStockClearing;
    }

    @Basic
    @Column(name = "IS_ON_DER_FORTS_MRKT", nullable = true, precision = 0)
    public Boolean getOnDerFortsMrkt() {
        return isOnDerFortsMrkt;
    }

    public void setOnDerFortsMrkt(Boolean onDerFortsMrkt) {
        isOnDerFortsMrkt = onDerFortsMrkt;
    }

    @Basic
    @Column(name = "IS_ON_STOCK_CLASSICA", nullable = true, precision = 0)
    public Boolean getOnStockClassica() {
        return isOnStockClassica;
    }

    public void setOnStockClassica(Boolean onStockClassica) {
        isOnStockClassica = onStockClassica;
    }

    @Basic
    @Column(name = "IS_ON_STOCK_STANDARD", nullable = true, precision = 0)
    public Boolean getOnStockStandard() {
        return isOnStockStandard;
    }

    public void setOnStockStandard(Boolean onStockStandard) {
        isOnStockStandard = onStockStandard;
    }

    @Basic
    @Column(name = "IS_ON_STOCK_MAIN", nullable = true, precision = 0)
    public Boolean getOnStockMain() {
        return isOnStockMain;
    }

    public void setOnStockMain(Boolean onStockMain) {
        isOnStockMain = onStockMain;
    }

    @Basic
    @Column(name = "IS_ON_MONEY_MRKT", nullable = true, precision = 0)
    public Boolean getOnMoneyMrkt() {
        return isOnMoneyMrkt;
    }

    public void setOnMoneyMrkt(Boolean onMoneyMrkt) {
        isOnMoneyMrkt = onMoneyMrkt;
    }

    @Basic
    @Column(name = "IS_ON_COMMODITY_MRKT", nullable = true, precision = 0)
    public Boolean getOnCommodityMrkt() {
        return isOnCommodityMrkt;
    }

    public void setOnCommodityMrkt(Boolean onCommodityMrkt) {
        isOnCommodityMrkt = onCommodityMrkt;
    }

    @Basic
    @Column(name = "IS_FOR_FORTS_STOCK", nullable = true, precision = 0)
    public Boolean getForFortsStock() {
        return isForFortsStock;
    }

    public void setForFortsStock(Boolean forFortsStock) {
        isForFortsStock = forFortsStock;
    }

    @Basic
    @Column(name = "IS_FOR_FORTS_MONEY", nullable = true, precision = 0)
    public Boolean getForFortsMoney() {
        return isForFortsMoney;
    }

    public void setForFortsMoney(Boolean forFortsMoney) {
        isForFortsMoney = forFortsMoney;
    }

    @Basic
    @Column(name = "IS_FOR_FORTS_COMMODITY", nullable = true, precision = 0)
    public Boolean getForFortsCommodity() {
        return isForFortsCommodity;
    }

    public void setForFortsCommodity(Boolean forFortsCommodity) {
        isForFortsCommodity = forFortsCommodity;
    }

    @Basic
    @Column(name = "IS_IN_CLEARING", nullable = true, precision = 0)
    public Boolean getInClearing() {
        return isInClearing;
    }

    public void setInClearing(Boolean inClearing) {
        isInClearing = inClearing;
    }

    @Basic
    @Column(name = "IS_OPEN_ENDED", nullable = true, precision = 0)
    ...
    @Basic
    @Column(name = "IS_BROKER_ACCESS_CHANGE", nullable = true, precision = 0)
    public Boolean getBrokerAccessChange() {
        return isBrokerAccessChange;
    }

    public void setBrokerAccessChange(Boolean brokerAccessChange) {
        isBrokerAccessChange = brokerAccessChange;
    }

    @Basic
    @Column(name = "IS_DEALER_ACCESS_CHANGE", nullable = true, precision = 0)
    public Boolean getDealerAccessChange() {
        return isDealerAccessChange;
    }

    public void setDealerAccessChange(Boolean dealerAccessChange) {
        isDealerAccessChange = dealerAccessChange;
    }

    @Basic
    @Column(name = "IS_TRUST_ACCESS_CHANGE", nullable = true, precision = 0)
    public Boolean getTrustAccessChange() {
        return isTrustAccessChange;
    }

    public void setTrustAccessChange(Boolean trustAccessChange) {
        isTrustAccessChange = trustAccessChange;
    }

    @Basic
    @Column(name = "IS_ON_MOEX_DERIVATIVE_MARKET", nullable = true, precision = 0)
    public Boolean getOnMoexDerivativeMarket() {
        return isOnMoexDerivativeMarket;
    }

    public void setOnMoexDerivativeMarket(Boolean onMoexDerivativeMarket) {
        isOnMoexDerivativeMarket = onMoexDerivativeMarket;
    }

    @Basic
    @Column(name = "IS_ON_SPB_DERIVATIVE_MARKET", nullable = true, precision = 0)
    public Boolean getOnSpbDerivativeMarket() {
        return isOnSpbDerivativeMarket;
    }

    public void setOnSpbDerivativeMarket(Boolean onSpbDerivativeMarket) {
        isOnSpbDerivativeMarket = onSpbDerivativeMarket;
    }

    @Basic
    @Column(name = "IS_ON_MEB_DERIVATIVE_MARKET", nullable = true, precision = 0)
    public Boolean getOnMebDerivativeMarket() {
        return isOnMebDerivativeMarket;
    }

    public void setOnMebDerivativeMarket(Boolean onMebDerivativeMarket) {
        isOnMebDerivativeMarket = onMebDerivativeMarket;
    }

    @Basic
    @Column(name = "IS_IN_MAIN_TRADING_MODE", nullable = true, precision = 0)
    public Boolean getInMainTradingMode() {
        return isInMainTradingMode;
    }

    public void setInMainTradingMode(Boolean inMainTradingMode) {
        isInMainTradingMode = inMainTradingMode;
    }

    @Basic
    @Column(name = "IS_IN_MAIN_TRADING_MODE_T_PLUS", nullable = true, precision = 0)
    public Boolean getInMainTradingModeTPlus() {
        return isInMainTradingModeTPlus;
    }

    public void setInMainTradingModeTPlus(Boolean inMainTradingModeTPlus) {
        isInMainTradingModeTPlus = inMainTradingModeTPlus;
    }

    @Basic
    @Column(name = "IS_FOR_ANALYSIS", nullable = true, precision = 0)
    public Boolean getForAnalysis() {
        return isForAnalysis;
    }

    public void setForAnalysis(Boolean forAnalysis) {
        isForAnalysis = forAnalysis;
    }

    @Basic
    @Column(name = "IS_FOR_MONITORING", nullable = true, precision = 0)
    public Boolean getForMonitoring() {
        return isForMonitoring;
    }

    public void setForMonitoring(Boolean forMonitoring) {
        isForMonitoring = forMonitoring;
    }

    @Basic
    @Column(name = "IS_BANK_ACCESS_CHANGE", nullable = true, precision = 0)
    public Boolean getBankAccessChange() {
        return isBankAccessChange;
    }

    public void setBankAccessChange(Boolean bankAccessChange) {
        isBankAccessChange = bankAccessChange;
    }

    @Basic
    @Column(name = "IS_FOR_FORTS_COMMODITY2", nullable = true, precision = 0)
    public Boolean getForFortsCommodity2() {
        return isForFortsCommodity2;
    }

    public void setForFortsCommodity2(Boolean forFortsCommodity2) {
        isForFortsCommodity2 = forFortsCommodity2;
    }

    @Basic
    @Column(name = "IS_ON_OTC_MRKT", nullable = true, precision = 0)
    public Boolean getOnOtcMrkt() {
        return isOnOtcMrkt;
    }

    public void setOnOtcMrkt(Boolean onOtcMrkt) {
        isOnOtcMrkt = onOtcMrkt;
    }

    @Basic
    @Column(name = "IS_OMS_CANCELLATION", nullable = true, precision = 0)
    public Boolean getOmsCancellation() {
        return isOmsCancellation;
    }

    public void setOmsCancellation(Boolean omsCancellation) {
        isOmsCancellation = omsCancellation;
    }

    @Basic
    @Column(name = "IS_OMS_CLOSED", nullable = true, precision = 0)
    public Boolean getOmsClosed() {
        return isOmsClosed;
    }

    public void setOmsClosed(Boolean omsClosed) {
        isOmsClosed = omsClosed;
    }

    @Basic
    @Column(name = "IS_GOVERNMENT_CONTRACT", nullable = true, precision = 0)
    public Boolean getGovernmentContract() {
        return isGovernmentContract;
    }

    public void setGovernmentContract(Boolean governmentContract) {
        isGovernmentContract = governmentContract;
    }

    @Basic
    @Column(name = "IS_CM_CLEARING_IDENTIFIER", nullable = true, precision = 0)
    public Boolean getCmClearingIdentifier() {
        return isCmClearingIdentifier;
    }

    public void setCmClearingIdentifier(Boolean cmClearingIdentifier) {
        isCmClearingIdentifier = cmClearingIdentifier;
    }

    @Basic
    @Column(name = "IS_ON_BR_UNSEC_LOAN", nullable = true, precision = 0)
    public Boolean getOnBrUnsecLoan() {
        return isOnBrUnsecLoan;
    }

    public void setOnBrUnsecLoan(Boolean onBrUnsecLoan) {
        isOnBrUnsecLoan = onBrUnsecLoan;
    }

    @Basic
    @Column(name = "IS_ON_AO", nullable = true, precision = 0)
    public Boolean getOnAo() {
        return isOnAo;
    }

    public void setOnAo(Boolean onAo) {
        isOnAo = onAo;
    }

    @Basic
    @Column(name = "IS_ON_RO", nullable = true, precision = 0)
    public Boolean getOnRo() {
        return isOnRo;
    }

    public void setOnRo(Boolean onRo) {
        isOnRo = onRo;
    }

    @Basic
    @Column(name = "IS_SECURITY_CONCLUSION", nullable = true, precision = 0)
    public Boolean getSecurityConclusion() {
        return isSecurityConclusion;
    }

    public void setSecurityConclusion(Boolean securityConclusion) {
        isSecurityConclusion = securityConclusion;
    }

    @Basic
    @Column(name = "IS_ON_BRDM_OR_BRCM", nullable = true, precision = 0)
    public Boolean getOnBrdmOrBrcm() {
        return isOnBrdmOrBrcm;
    }

    public void setOnBrdmOrBrcm(Boolean onBrdmOrBrcm) {
        isOnBrdmOrBrcm = onBrdmOrBrcm;
    }

    @Basic
    @Column(name = "IS_ON_BRDM", nullable = true, precision = 0)
    public Boolean getOnBrdm() {
        return isOnBrdm;
    }

    public void setOnBrdm(Boolean onBrdm) {
        isOnBrdm = onBrdm;
    }

    @Basic
    @Column(name = "IS_ON_BRCM", nullable = true, precision = 0)
    public Boolean getOnBrcm() {
        return isOnBrcm;
    }

    public void setOnBrcm(Boolean onBrcm) {
        isOnBrcm = onBrcm;
    }

    @Basic
    @Column(name = "IS_ON_FTDM", nullable = true, precision = 0)
    public Boolean getOnFtdm() {
        return isOnFtdm;
    }

    public void setOnFtdm(Boolean onFtdm) {
        isOnFtdm = onFtdm;
    }

    @Basic
    @Column(name = "IS_ON_DEPOSIT_MRKT", nullable = true, precision = 0)
    public Boolean getOnDepositMrkt() {
        return isOnDepositMrkt;
    }

    public void setOnDepositMrkt(Boolean onDepositMrkt) {
        isOnDepositMrkt = onDepositMrkt;
    }
